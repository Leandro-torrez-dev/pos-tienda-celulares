...
function App() {
  ...
  const [isCartOpen, setIsCartOpen] = useState<boolean>(false); // Nuevo estado para abrir/cerrar el carrito
  ...
  // CÁLCULOS QUE SE RECALCULAN EN CADA RENDER
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-4 md:p-6 relative">
      ...
      <header className="mb-6 text-center">
        ...
        <p className="text-gray-500 mt-1">Prueba Técnica - Frontend Junior</p>
      </header>
      ...
      {/* VISTA DEL CATÁLOGO (Ocupa el ancho completo de forma limpia) */}
                ...
                {filteredProducts.map((product) => (
                  <div key={product.id} className="bg-white p-4 rounded-xl shadow-sm border border-gray-200 flex flex-col justify-between hover:shadow-md transition-shadow">
                    <div className="flex gap-4">
                      <div className="w-20 h-20 flex-shrink-0 flex items-center justify-center p-1 bg-gray-50 rounded-lg">
                    ...
                    <button
                      ...
                      className="w-full mt-3 bg-blue-600 hover:bg-blue-700 text-white font-medium py-1.5 rounded-lg text-xs transition-colors"
                    >
                      + Agregar al Carrito
                    </button>
                  </div>
      ...
      {isCartOpen && (
        <div className="fixed inset-0 z-50 flex justify-end">
          {/* Fondo oscuro translúcido para cerrar el carrito al hacer clic afuera */}
          <div className="fixed inset-0 bg-black/40 transition-opacity" onClick={() => setIsCartOpen(false)} />
            ...
            <div className="border-b border-gray-100 pb-3 mb-3 flex justify-between items-center">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="text-gray-400 hover:text-gray-600 font-bold text-xl p-1 rounded-lg"
                >
                  ✕
                </button>
              </div>
                    ...
                    <div className="flex items-center gap-2">
                      <div className="flex items-center border border-gray-200 bg-white rounded-md">
                        <button
                          ...
                          className="px-2 py-0.5 text-gray-600 hover:bg-gray-100 font-bold text-xs"
                        >
                          -
                        </button>
